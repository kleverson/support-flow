...
public class TicketController {
    ...
    public ResponseEntity<Page<TicketResponse>> getAll(
        ...
        return ResponseEntity.ok(ticketService.getAll(term, page, size, clientId, authentication));
    }
    ...
    public ResponseEntity<?> create(
        ...
        return ResponseEntity.ok(ticketService.create(ticketPostBody, clientId, authentication));
    }
    ...
    public ResponseEntity<?> update(
        ...
        return ResponseEntity.ok(ticketService.update(id, ticketPostBody, clientId, authentication));
    }
    ...
    public ResponseEntity<?> assigned(
            ...
            @Valid @RequestBody TicketAssign assign,
            @RequestHeader("X-Client-Id") String clientId,
            Authentication authentication
    ) {
        return ResponseEntity.ok(ticketService.assign(id, assign, clientId, authentication));
    }
    ...
    public ResponseEntity<?> changeStatus(
        ...
        return ResponseEntity.ok(ticketService.changeStatus(id, body.status(), clientId, authentication));
    }
}
